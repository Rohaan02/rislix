      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-6">
          <a
            ...
            className="flex items-center gap-1.5 font-semibold hover:text-[#4ade80] transition-colors"
          >
        ...
        <div className="hidden md:flex items-center gap-6">
          {[
            ...
            <button
              ...
              className="font-semibold text-blue-100 hover:text-[#4ade80] transition-colors"
            >
              {label}
            </button>
          ))}
