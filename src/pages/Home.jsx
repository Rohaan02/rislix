    ...
    <div>
      ...
      <section className="relative bg-[#0f172a] text-white overflow-hidden min-h-[88vh] flex items-center">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute inset-0 opacity-[0.03]" style={{backgroundImage:"radial-gradient(circle at 1px 1px, #16a34a 1px, transparent 0)",backgroundSize:"44px 44px"}}></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-28 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="text-4xl lg:text-[3.2rem] font-black leading-tight mb-6 tracking-tight">
              ...
              <span className="text-[#16a34a]">Confidence,</span> Security That<br />
          ...
          <div className="hidden lg:flex items-center justify-center">
            <div className="relative w-96 h-96">
              {/* Animated rings */}
              <div className="absolute inset-0 rounded-full border border-[#16a34a20] animate-ping" style={{animationDuration:"3s"}}></div>
              ...
              <div className="absolute inset-28 rounded-full bg-[#16a34a18] border border-[#16a34a80] flex items-center justify-center">
                <div className="text-center">
                  <div className="text-[#16a34a] font-black text-2xl tracking-widest">RISLIX</div>
              ...
              {[
                ...
                <div key={b.label} className={`absolute ${b.pos} bg-[#0f172a] border border-[#16a34a40] text-white px-3 py-1.5 rounded-xl shadow-xl text-xs font-semibold flex items-center gap-1.5 whitespace-nowrap`}>
