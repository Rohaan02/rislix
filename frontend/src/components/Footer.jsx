  ...
  return (
    <footer className="bg-[#0f172a] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-4">
              ...
              solutions for regulated organizations worldwide.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-bold text-lg mb-4 text-[#4ade80]">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <div className="mt-6 bg-[#16a34a]/10 border border-[#16a34a]/30 rounded-xl p-4">
              ...
              <a
                href="mailto:info@rislix.com"
                className="text-white font-semibold text-sm hover:text-[#4ade80] transition-colors"
              >
                info@rislix.com
              </a>
            </div>
      ...
      <div className="border-t border-white/10 py-4">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-2 text-sm text-slate-500">
