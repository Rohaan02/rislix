...
const plansData = [
  ...
  },
  {
    ...
    highlighted: true,
    features: [
      "Up to 20 hrs/month advisory",
      "ISO 27001 / NIST CSF roadmap",
  ...
  },
  {
    ...
    highlighted: false,
    features: [
      "GDPR / regional PDPL compliance",
      "DPIA program management",
      "ROPA documentation",
  ...
  },
  {
    ...
    highlighted: false,
    features: [
      "ISO 27001 / NIST CSF gap analysis",
  ...
  },
  {
    ...
    highlighted: false,
    features: [
      "Network pen test (internal/external)",
...
export default function Pricing({ navigate }) {
  ...
  return (
    <div>
      <Helmet>
        <title>Pricing | RISLIX</title>
        <meta
          name="description"
          content="Transparent pricing for our cybersecurity and compliance services. Get a tailored quote for your organization."
        />
      </Helmet>
      <section className="bg-[#0f172a] text-white py-24">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto text-lg">
            Clear, transparent pricing with no hidden fees. Contact us for a
            tailored quote based on your specific needs.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
            ...
            {plansData.map((plan, i) => (
              <div
                ...
                className={`bg-white rounded-2xl border-2 overflow-hidden relative ${
                  plan.highlighted
                    ? "border-[#16a34a] shadow-2xl shadow-[#16a34a20] scale-105"
              ...
              >
                ...
                <div
                  className={`p-8 ${
                    plan.highlighted
                      ? "bg-gradient-to-br from-[#0f172a] to-[#1e3a5f] text-white"
                      : ""
                  }`}
                >
                  <h3
          ...
          <p className="text-center text-gray-500 text-sm mt-8">
            All prices are indicative. Final pricing depends on organization
            size, scope, and jurisdiction.{" "}
            <button
              onClick={() => navigate("contact")}
